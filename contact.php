...
<head>
    ...
    <script src="js/enrolledscript.js"></script>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="contact-text">
                        <h3>Get in touch</h3>
                        <p>At STARR Agency there is no such thing as missing memory, give us a chance and watch us 
                            make the magic.</p>
                        <div class="ct-item">
                            <div class="ct-icon">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact-form">
                        <h3>Work with Me!</h3>
                        <form id="form" method = "POST" action="controllbck.php">
                            <input id = "name" name = "name" type="text"  value = "name" placeholder="Name" required>
                            <input id = "email"name = "email" type="text" value = "email" placeholder="Email"required>
                            <input id = "number"name = "num" type="text"  value = "number" placeholder="Phone Number"required>
                            <textarea value = "message" name = "message"  placeholder="Message" required></textarea>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="fs-about">
                        ...
                        <div class="fa-social">
                            ...
                            <a href="https://twitter.com/photography"><i class="fa fa-youtube-play"></i></a>
