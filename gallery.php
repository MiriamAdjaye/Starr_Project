<?php
    ...
    function buttonhandler(){
        ...
        $dir = "img/gallery/";
        $dir= __DIR__."C:\xampp\documents\htdocs\STARR_Project\gallery.php";
        $files = scandir($dir);
        $i = 1;
        $count = count($files);
...
<body>
    ...
    <div class="gallery-section spad">
        ...
        <button id = "butt1"  onclick="buttonhandler()" class= "btn btn-success m-3">Load More</button>
        
         <!-- // Load more images onto the page  -->
        <script>
                ...
                $(document).ready(function(){
                    $.ajax({
                        ...
                        console.log(images[1])
                            for (var i = 18, j = images; i <= j; i++){
                            $("#imageContent").append("<div class='gf-item medium-small-height set-bg wedding' data-setbg='img/gallery/gallery-"+i+".jpg'> <a href='img/gallery/gallery-"+i+".jpg' class='gf-icon image-popup'><span class='icon_plus'></span></a> </div>"); 
                            }
