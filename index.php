        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="logo">
                        <a href="./index.php">
                            <img src="img/about/vin-starr.jpg" alt="STARR logo">
                        </a>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hs-text">
                                <h2>STARR Agency</h2>
                                <p>STARR is the future of Photography in Ghana, we have Ultra modern technologies that enables 
                                    you to be the best<br /> and have the best of memories captured.
                                </p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hs-text">
                                <h2>STARR Agency</h2>
                                <p>With our afforable price nothing seems like a lost. Trust STARR and we will deliver
                                    beyond your expectation<br /> Don't be shy give us a call or visit our studio 
                                    to become a STARRLET.</p>
                                <a href="contact.php" class="primary-btn">Contact us</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-item">
                        ...
                        <h3>Shooting</h3>
                        <p>With our creative ideas and top notch tecnnology and equipment, we capture and creating every living moment</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-item">
                        ...
                        <h3>Videos</h3>
                        <p>STARR is all about bringing your creative side to life, we make videos that represent 
                            your true self using high-quality cameras and studio lights.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-item">
                        ...
                        <h3>Editing</h3>
                        <p>Whether blemishes or errors we make sure your events, photos and videos come out just as you.
                           With the best editing software and skills, you have nothing to worry about.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="section-title">
                        <h2>Snippets of what we can do</h2>
                        <p>Below are few samples of what STARR really offers<br /> refreshing
                            ideas and shoot from our team!.</p>
                    </div>
                </div>
            </div>
