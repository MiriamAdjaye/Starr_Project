            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-title pricing-title">
                        ...
                        <p>With our aim to please and offer the best<br /> We give affordable prices for our various appointments 
                            so relax, we gotcha ya!.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="pricing-item">
                        ...
                        <div class="pi-text">
                            ...
                            <a href="priced.php" class="primary-btn">Get appointment</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="so-item">
                        ...
                        <p>With STARR, a maximum of three days is require to find an appropriate venue for shooting of films, music videos
                            and a minimum of seven days to edit and send work either via mail or post.
                        </p>
                    </div>
                    <div class="so-item">
                        <div class="so-title">
                        ...
                        <p>STARR works hand in hand with the client's decor team and makeup team to ensure every process is captured, 
                            to make it a memorable day. This should be done prior before the event.</p>
                    </div>
                    <div class="so-item">
                        <div class="so-title">
                            <div class="so-number">03</div>
                            <h5>Content photography</h5>
                        </div>
                        <p>At STARR our team ensure that the setting up of the place goes will with the product/ services, 
                            a meeting is held via zoom or in person to discuss ideas and style for the product/ services.</p>
                    </div>
                </div>
                </div>
            </div>
